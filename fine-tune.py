...
def fine_tune_model(params_obj, pruned_ckpt_path, train_file_list):
    ...
    for epoch in range(3,6):
        ...
        torch.save({'model_state': model.state_dict()}, f"weights/fine-tuned models/pruned_1_layers_epoch_{epoch+1}.ckpt")
        run_full_year_benchmark(params_obj, f"weights/fine-tuned models/pruned_1_layers_epoch_{epoch+1}.ckpt", "data/out_of_sample/2018.h5", num_steps=1)
...
if __name__ == "__main__":
    ...
    fine_tune_model(params_obj, "weights/fine-tuned models/pruned_1_layers_epoch_3.ckpt", training_files)